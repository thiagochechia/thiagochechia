...
def ajuda():
    ...
    if resposta == "1":
            ...
            print("www.discord.com/turmavamoai/faq , seu atendimento sera reiniciado, aperte 4 no menu principal se deseja sair")
    elif resposta == "4":
        return
    else:
            print("Desculpe, não entendi sua resposta. Por favor, tente novamente.")
...
#while True:
       # resposta_continuar = input("Você gostaria de continuar no atendimento? (s/n)\n")
      #  if resposta_continuar.lower() == "s":
       #     break
       # elif resposta_continuar.lower() == "n":
